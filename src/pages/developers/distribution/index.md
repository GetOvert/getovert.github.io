...
- For Homebrew:
  - [Contibute](https://docs.brew.sh/How-To-Open-a-Homebrew-Pull-Request#cask-related-pull-request) if your software is deemed acceptable ([acceptable casks](https://docs.brew.sh/Acceptable-Casks) / [acceptable formulae](https://docs.brew.sh/Acceptable-Formulae))
